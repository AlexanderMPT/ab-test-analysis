...
> Предварительно - исходя из данного графика можем понять, что примерно 11.09 числа - был большой всплеск на оформление карт (80+), что может быть вызвано рекламной компанией которую недавно провел Т-банк.
